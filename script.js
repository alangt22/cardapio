...
function addToCart(name, price){
    ...
    if(existingItem){
        //se o item existe aumenta a qnt +1
...
addressInput.addEventListener("input", function(event){
    let inputValue = event.targey.value;
...
checkoutBtn.addEventListener("click", function(){
    ...
    const phone = "11940094503"

    window.open(`https://wa.me/${phone}?text=${message} Valor Total: R$${cartTotal.textContent} endereço: ${addressInput.value}`, "_blank")
